...
const NavbarLayout: React.FC = () => {
	...
	return (
		<div className='w-screen'>
			<nav className='flex items-center justify-between p-2 pl-4 text-white bg-emerald-800/80  w-[98%] max-w-[1280px] fixed top-2 left-1/2 -translate-x-1/2 rounded-xl border-emerald-600 shadow-2xl border z-50 backdrop-blur-3xl'>
				<div>
				...
				<div className='hidden lg:flex gap-8 items-center'>
					...
					<RippleButton className='active:scale-95 transition-all p-0 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 duration-300'>
						{!isAuthenticated ? (
							<Link
								to='/login'
				...
				{/* Mobile Menu */}
				{isMenuOpen && (
					<div className='lg:hidden absolute top-full left-0 right-0 mt-2 bg-emerald-800/90 rounded-3xl py-4 border border-emerald-600'>
						<div className='flex flex-col items-center gap-4'>
							...
							<RippleButton className='active:scale-95 transition-all p-0 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 duration-300'>
								{!isAuthenticated ? (
									<Link
										to='/login'
										className='px-4 py-1.5'
