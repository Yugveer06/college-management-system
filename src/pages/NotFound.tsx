	...
	return (
		<div className='min-h-screen flex items-center justify-center'>
			<div className='text-center'>
				...
				<RippleButton className='mt-8 active:scale-95 transition-all group rounded-lg bg-emerald-600 px-6 py-3 hover:bg-emerald-700 p-0 h-fit border border-neutral-500/50'>
